...
public class MySpringApplication {
    ...
    @Bean
    public RandomGeneratorNumberService bigNumber() {
        return new RandomGeneratorNumberService(100, 1000);
    }

    @Bean
    public RandomGeneratorNumberService smallNumber() {
        return new RandomGeneratorNumberService(50);
    }
